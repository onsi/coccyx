var coccyxTearDownSpecs = function(root) {
  var CustomView = root.View.extend({
    ...
    initialize: function() {
      ...
      this.otherModel = new root.Model();
  ...
  var CustomSubView = root.View.extend({
    className: 'sub-view',

    initialize: function() {
      this.modelChanges = 0;
      this.model = new root.Model();
      this.model.on('change', this.modelChange, this);
    },
  ...
  describe('Coccyx', function() {
    ...
    beforeEach(function() {
      model = new root.Model();
      collection = new root.Collection([]);
      view = new CustomView({
        model: model,
    ...
    describe('registering event dispatchers', function() {
      var dispatcher;
      beforeEach(function() {
        dispatcher = _.clone(root.Events);
